            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
              <div className="flex items-center justify-between h-16">
                ...
                <Link href="/portal/dashboard" className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-foreground text-lg">ApexCRM</span>
                  <span className="hidden sm:inline text-xs text-muted-foreground font-medium border border-border rounded px-1.5 py-0.5 ml-1">
                    Client Portal
                  </span>
                </Link>
                ...
                <div className="flex items-center gap-3">
                  <ThemeToggle />
                  <span className="hidden lg:block text-sm text-muted-foreground max-w-[140px] truncate">
