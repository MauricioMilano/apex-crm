          ...
          <div className="flex items-center gap-4">
            <div className="relative shrink-0">
              ...
              <button
                ...
                className="absolute -bottom-1 -right-1 bg-gray-800 border border-gray-700 rounded-full p-1.5 hover:bg-gray-700 transition-colors disabled:opacity-50"
          ...
          <form onSubmit={profileForm.handleSubmit(onSaveProfile)} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {profileForm.formState.errors.firstName && (
                  <p className="text-sm text-red-400">{profileForm.formState.errors.firstName.message}</p>
                )}
              </div>
              <div className="space-y-2">
                ...
                {profileForm.formState.errors.lastName && (
                  <p className="text-sm text-red-400">{profileForm.formState.errors.lastName.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  type="email"
                  className="pl-9 bg-gray-800 border-gray-700 text-gray-100 focus:border-blue-500"
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              {profileForm.formState.errors.phone && (
                <p className="text-sm text-red-400">{profileForm.formState.errors.phone.message}</p>
              )}
            </div>

            <Button type="submit" disabled={profileSaved} className="bg-blue-600 hover:bg-blue-700">
              {profileSaved ? (
                <>
      ...
      <Card className="border-red-900/50 bg-gray-900">
        ...
        <CardContent>
          <p className="text-sm text-gray-400 mb-4">
            ...
            <a href="mailto:support@apex.com" className="text-blue-400 hover:underline">
              support@apex.com
            </a>
          ...
          <Button
            variant="outline"
            disabled
            className="text-red-400 border-red-900/50 cursor-not-allowed opacity-60"
          >
